...
"[project]/src/app/admin/ingredients/data:1268fb [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$ingredients$2f$data$3a$1268fb__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/admin/ingredients/data:1268fb [app-ssr] (ecmascript) <text/javascript>");
...
function IngredientsClient({ initialIngredients }) {
    ...
    const [optimisticIngredients, addOptimisticIngredient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useOptimistic"])(initialIngredients, (state, newIngredient)=>[
            ...state,
            newIngredient
    ...
    const handleFormSubmit = async (formData)=>{
        ...
        setDialogOpen(false);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$ingredients$2f$data$3a$1268fb__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addIngredient"])(formData);
        if (result.success) {
            toast({
...
//# sourceMappingURL=src_8665dcb3._.js.map