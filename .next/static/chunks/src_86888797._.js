...
"[project]/src/components/admin/reports-client.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function ReportsClient({ initialOrders }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportsClient.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "ReportsClient.useEffect.unsubscribe": (querySnapshot)=>{
                    const liveOrders = [];
                    querySnapshot.forEach({
                        "ReportsClient.useEffect.unsubscribe": (doc)=>{
                            const data = doc.data();
                            liveOrders.push({
                                id: doc.id,
                                ...data,
                    ...
                    }["ReportsClient.useEffect.unsubscribe"]);
    ...
    const reportData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReportsClient.useMemo[reportData]": ()=>{
            const totalRevenue = orders.reduce({
                "ReportsClient.useMemo[reportData].totalRevenue": (acc, order)=>acc + order.total
            }["ReportsClient.useMemo[reportData].totalRevenue"], 0);
            const totalOrders = orders.length;
            const averageOrderValue = totalOrders > 0 ? totalRevenue / totalOrders : 0;
            const totalPrepTime = orders.reduce({
                "ReportsClient.useMemo[reportData].totalPrepTime": (acc, order)=>acc + order.totalPreparationTime
            }["ReportsClient.useMemo[reportData].totalPrepTime"], 0);
            const averagePrepTime = totalOrders > 0 ? totalPrepTime / totalOrders : 0;
            const orderTypeCounts = orders.reduce({
                "ReportsClient.useMemo[reportData].orderTypeCounts": (acc, order)=>{
                    const type = order.orderType || 'Unknown';
                    acc[type] = (acc[type] || 0) + 1;
                    return acc;
                }
            }["ReportsClient.useMemo[reportData].orderTypeCounts"], {});
            const orderTypeData = Object.entries(orderTypeCounts).map({
                "ReportsClient.useMemo[reportData].orderTypeData": ([name, value])=>({
                        name,
                        value
                    })
            }["ReportsClient.useMemo[reportData].orderTypeData"]);
            const topSellingItems = orders.flatMap({
                "ReportsClient.useMemo[reportData].topSellingItems": (order)=>order.items
            }["ReportsClient.useMemo[reportData].topSellingItems"]).reduce({
                "ReportsClient.useMemo[reportData].topSellingItems": (acc, item)=>{
            ...
            }["ReportsClient.useMemo[reportData].topSellingItems"], new Map());
            const sortedTopItems = Array.from(topSellingItems.values()).sort({
                "ReportsClient.useMemo[reportData].sortedTopItems": (a, b)=>b.quantity - a.quantity
            }["ReportsClient.useMemo[reportData].sortedTopItems"]).slice(0, 5);
            const revenueByDay = orders.reduce({
                "ReportsClient.useMemo[reportData].revenueByDay": (acc, order)=>{
            ...
            }["ReportsClient.useMemo[reportData].revenueByDay"], {});
            const dailyRevenueData = Object.entries(revenueByDay).map({
                "ReportsClient.useMemo[reportData].dailyRevenueData": ([date, revenue])=>({
                        date,
                        revenue: parseFloat(revenue.toFixed(2))
                    })
            }["ReportsClient.useMemo[reportData].dailyRevenueData"]).sort({
                "ReportsClient.useMemo[reportData].dailyRevenueData": (a, b)=>new Date(a.date).getTime() - new Date(b.date).getTime()
            }["ReportsClient.useMemo[reportData].dailyRevenueData"]).slice(-30);
            return {
                totalRevenue,
                totalOrders,
                averageOrderValue,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground",
                        children: "A real-time overview of your sales performance."
                    }, void 0, false, {
                        fileName: "[project]/src/components/admin/reports-client.tsx",
                        lineNumber: 106,
                        columnNumber: 17
...
_s(ReportsClient, "CNT7oe+K34aIzJ956Xr3nF4kE6Y=");
_c = ReportsClient;
var _c;
...
//# sourceMappingURL=src_86888797._.js.map