...
function OrderSummary({ order, onUpdateQuantity, onRemoveItem, onNewCheck, onCheckout }) {
...
function Home() {
    ...
    const handleUpdateQuantity = (itemId, quantity)=>{
        ...
        setOrder((prevOrder)=>prevOrder.map((item)=>item.id === itemId ? {
                    ...item,
                    quantity
                } : item));
    };
...
_s(Home, "UXYGUwMXrsFKo4T8J0ukPMUkiS0=", false, function() {
    return [
...
//# sourceMappingURL=src_43d0a480._.js.map